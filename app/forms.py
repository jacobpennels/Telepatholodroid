...
class RegistrationForm(RedirectForm):
    title = SelectField(u'Title <span class="star">*</span>', choices=[('Dr', 'Dr'), ('Mr', 'Mr'), ('Miss', 'Miss'), ('Mrs', 'Mrs'), ('Ms', 'Ms')], validators=[validators.DataRequired()], render_kw={'data-native-menu': 'false'})
    fname = StringField(u'Firstname <span class="star">*</span>', validators=[validators.DataRequired(), validators.length(max=20)], render_kw={'data-clear-btn':'true', 'placeholder': '...'})
    lname = StringField(u'Lastname <span class="star">*</span>', validators=[validators.DataRequired(), validators.length(max=20)], render_kw={'data-clear-btn':'true', 'placeholder': '...'})
    institute = StringField(u'Institute <span class="star">*</span>', validators=[validators.DataRequired(), validators.length(max=50)], render_kw={'data-clear-btn':'true', 'placeholder': '...'})
    country = SelectField(u'Country <span class="star">*</span>', validators=[validators.DataRequired()], choices=country_list, render_kw={'data-native-menu': 'false'})
    email1 = EmailField(u'Email <span class="star">*</span>', validators=[validators.DataRequired(), validators.Email(), validators.EqualTo('email2')], render_kw={'data-clear-btn': 'true', 'placeholder': '...'})
    email2 = EmailField(u'Confirm Email <span class="star">*</span>', validators=[validators.DataRequired(), validators.Email()], render_kw={'data-clear-btn': 'true', 'placeholder': '...'})
